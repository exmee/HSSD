...
class Loader():
    ...
    def load_filenames(self):
        ...
        files = glob(osp.join(DEMO_DIR, '*{}'.format(self.data_format)))
    ...
    def load_image(self, name=None, path=None):
        ...
        path = path if path else osp.join(DEMO_DIR, name + self.data_format)
...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    loader = Loader(osp.join(EVAL_DIR, 'demodemo/test'))
